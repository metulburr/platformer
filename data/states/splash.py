...
class Splash(tools.States):
    def __init__(self, screen_rect):
        ...
        self.image_orig = pg.image.load('resources/graphics/splash_page.png').convert_alpha()
        ...
        self.rendered_text = self.make_text_list("Fixedsys500c",50,text,(0,0,0),220,50)
